$(document).ready(function()
{
    ...
    .bind("tabsselect",function(e,ui)
    {
    	...
    	if(ui.index===1)
    	{
    		$("#combined").hide().next().hide();
    		loadOrdersList("订货单");
    	}
    	else if(ui.index===2)
    	{
    		$("#combined").show().next().show();
    		loadOrdersList("出库单");
    	}
    });
	...
	.click(function()
		{
			delete localStorage._newEastMarketOrderDetails;
			var orders=[];
			$("#orders tr.datarow")
			.each(
				function()
