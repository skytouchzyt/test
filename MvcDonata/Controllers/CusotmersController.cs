...
namespace MvcDonata.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public ActionResult CalcNextCustomerScore(string startNumber)
        {
            try
            {
                ...
                {
                    successed = true,
                    result = Models.BusinessObject.CalcNextCustomerScore(startNumber).SerializeToJson(false)
                };
        ...
        public ActionResult GetCustomersOrderByScore()
        {
            return Json(Models.BusinessObject.GetCustomersOrderByScore(), JsonRequestBehavior.AllowGet);
        }
